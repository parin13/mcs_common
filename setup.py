...
def get_version():
    main_file = os.path.join(CURDIR, "mcs_common", "main.py")
...
setup(
    ...
    url="https://github.com/parin13/mcs_common",
    packages=find_packages(exclude=EXCLUDE_FROM_PACKAGES),
    include_package_data=True,
    keywords=[],
    scripts=[],
    entry_points={"console_scripts": ["mcs_common=mcs_common.common_util :main"]},
    zip_safe=False,
